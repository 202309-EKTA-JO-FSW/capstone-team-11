...
export default function VipCard() {
  return (
    <div className=" w-11/12 bg-[#f0f0f0] dark:bg-gray-700 rounded-xl mx-auto my-12 flex flex-col md:flex-row lg:flex-row xl:flex-row justify-center items-center">
      <div className=" flex flex-col md:flex-row lg:flex-row xl:flex-row justify-center items-center">
        <svg
          className="fill-[#030303] dark:fill-slate-100 w-24 h-24 md:w-12 lg:w-12 xl:w-12 md:h-12 mx-8 my-[22px]"
          viewBox="0 0 320 512"
        >
        ...
        <div className="flex flex-col justify-start m-4">
          <h3 className=" text-4xl md:text-2xl font-semibold text-center md:text-start lg:text-start xl:text-start">
            Exclusive Offers
          </h3>
          <h5 className="text-lg md:text-lg font-light text-balance text-center md:text-start lg:text-start xl:text-start">
      ...
      <Button
        title="Join VIP Club"
        addClassName="mx-auto text-lg mt-8 mb-12 px-16 md:px-5 md:mt-0 md:mb-0  md:mr-8 md:mb-1 lg:px-5 lg:mt-0 lg:mb-0  lg:mr-8 lg:mb-1 xl:px-5 xl:mt-0 xl:mb-0  xl:mr-8 xl:mb-1 w-10/12 md:w-1/2 lg:w-1/5 xl:w-1/6"
      />
    </div>
  );
}
