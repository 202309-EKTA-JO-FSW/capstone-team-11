    ...
    <div className=" min-h-screen font-['Poppins']  ">
      ...
      <div className=" bg-[#f0f0f0] pb-10 rounded-lg mx-auto md:max-w-2xl lg:max-w-2xl xl:max-w-2xl min-w-min ">
        <form
          ...
          action="http://localhost:3001/events"
          method="post"
        ...
        >
          ...
          <div className=" w-full px-4 flex flex-col mx-4  mb-3">
            ...
            <select
              name="location"
              className=" w-full px-4 resize-y h-12 border  border-gray-300 rounded-md bg-opacity-80 bg-white text-gray-800 text-base font-poppins font-medium outline-none"
            >
              <option>Amman</option>
          ...
          <div
            name="location"
            className=" w-full px-4 flex flex-col mx-4  mb-3"
          >
            <div className=" w-full  text-black py-2 font-medium leading-4">
              Address:
            </div>
          ...
          <div className=" w-full px-4 flex items-center mb-5">
            <div className="  text-black py-2 font-medium leading-4">
              Number Of Guests:
            </div>
            <input
              type="number"
          ...
          <div className=" w-full">
            <div className="flex flex-col justify-center ">
              <div className=" w-ful text-center text-black py-2 font-medium leading-4 self-start ml-4">
                Catagories:
              </div>
          ...
          <div className=" flex flex-col items-center pt-10 w-full px-4 ">
            <button
              type="submit"
              className="  px-4 cursor-pointer  w-48 min-w-20 max-w-72 h-10  border-0 box-border rounded-lg bg-gray-900 text-white text-base font-poppins leading-5 outline-none"
            >
              Submit
            </button>
          </div>
